...
<div class="errortext">
    ...
    <h2>Would you like us to show you back home?</h2>
    
    <br><br> <br><br> <br>
    <br><br> <br><br> <br>
    <br><br> <br>
    <form action="fuelManagement" method="post">
    	<center><input style="background-color: #ad7b15; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;" type="submit" value="Home"></center>
    </form>
</div>
</div>
