...
<body background ="${pageContext.request.contextPath}/images/img16.jpeg" >
...
<div class="background">
  ...
  <br><br>
    <form action="deleteTank" method="post">
    <br><br>
        <h3>Delete Fuel Tank</h3>
        ...
        <input type="text" placeholder="Enter Tank Capacity:" name="TankCapacity" value="<%= TankCapacity %>"readonly>
        
        <label for="Enter Current Capacity of Tank :">Enter Current Capacity of Tank :</label>
        <input type="text" placeholder="Enter Current Capacity of Tank :" name="CurrentTankCapacity" value="<%=CurrentTankCapacity %>"readonly>
        
        <label for="Refilled Date:">Refilled Date:</label>
        <input type="Date" placeholder="Refilled Date:" name="RefilledDate" value="<%= RefilledDate %>"readonly>
        
        <label for="Estimated refill Date:">Estimated refill Date:</label>
        <input type="text" placeholder="Estimated refill Date:" name="EstimatedrefillDate" value="<%= EstimatedrefillDate %>"readonly>
        
        <label for="Fuel Type:">Fuel Type:</label>
        <input type="text" placeholder="Fuel Type:" name="FuelType" value="<%= FuelType %>"readonly>
	
		<button type="submit">Remove Tank</button>
